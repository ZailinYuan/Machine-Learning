...
stop_word = re.compile('(|a|about|above|after|again|against|all|am|an|and|any|are|aren\'t|as|at|be|because|been|before|'
...
def file_loader(path0, path1):
    ...
    text_block = re.sub(stop_word, ' ', text_block)
